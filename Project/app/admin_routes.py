...
def admin_dashboard():
    ...
    return render_template('dashboard3.html', queries=queries, enumerate=enumerate, username=username)

@admin_routes.route('/admin/query/<int:query_id>', methods=['get'])
def view_query(query_id):
    ...
    return render_template('response_page.html', query=query, username=username)
...
def respond():
    ...
    return redirect(url_for('admin_routes.admin_dashboard', username=username))
