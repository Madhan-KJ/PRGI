...
def official_dashboard(username):
    ...
    return render_template('dashboard2.html', registered_titles=registered_titles, username=username, enumerate=enumerate, notifications=notifications, check=check[0])
